      ...
      <div className={tw(`container mx-auto px-6 p-6 bg-white`)}>
        ...
        <div className={tw(`flex flex-wrap my-12`)}>
          <div className={tw(`w-full border-b md:w-1/2 pb-8 md:p-4 md:border-r lg:w-1/3 lg:p-8`)}>
            ...
            <p className={tw(`leading-loose text-gray-500`)}>Стандартно, оплата ремонта квартиры в Геленджике под ключ, у нас разбита на 3 этапа. После заключения договора и оплаты первой части мы приступаем к работам. По завершении этапа, клиент принимает работу и оплачивает следующую часть. При необходимости, платежи за ремонт квартиры в Геленджике под ключ, можно разбить на большее количество частей.</p>
          </div>
          <div className={tw(`w-full border-b pt-8 pb-8 md:w-1/2 md:p-4 lg:w-1/3 lg:border-r lg:p-8`)}>
            ...
            <p className={tw(`leading-loose text-gray-500 `)}>Вариант дистанционного ремонта квартиры в Геленджике подойдет тем, у кого нет возможности присутствовать в городе на период работ. При этом мы будем держать вас в курсе, отправляя ежедневные фото и видео отчеты. В формате дистанционного ремонта квартиры в Геленджике с нами сотрудничают порядка 30% клиентов.</p>
          </div>
