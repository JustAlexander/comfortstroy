      ...
      <div className={tw(`flex flex-wrap items-center`)}>
        ...
        <div className={tw(`w-full lg:w-1/2 px-8`)}>
          <div className={tw(`lg:mb-12 lg:mb-0 pb-12 lg:pb-0 mt-16 lg:mt-0 mx-6 lg:mx-0`)}>
            <Image width="100%" height="100%" src="/images/remont-odnokomnatnoj-kvartiry-gelendzhik.avif" layout="responsive" alt="Ремонт однокомнатной квартир в Новороссийске под ключ" />
          </div>
        </div>
