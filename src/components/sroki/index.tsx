    ...
    <div className={tw(`max-w-7xl mx-auto px-6 sm:p-6 lg:p-8`)}>
      ...
      <div className={tw(`flex flex-wrap items-center`)}>
        ...
        <div className={tw(`w-full py-6 text-center mx-auto`)}>
          <Image width="100%" height="40%" src="/images/sroki-remonta-kvartiry-novostroyki-v-gelengjike1.webp" layout="responsive" alt="Сроки на ремонт квартиры в Краснодаре" />
        </div>
      </div>
    </div>
  </section>
