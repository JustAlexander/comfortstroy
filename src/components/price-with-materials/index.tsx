  ...
  <section className={tw(`lg:py-28 pt-28 overflow-hidden`)}>
    <div className={tw(`max-w-7xl mx-auto py-4 px-6 sm:p-6 lg:p-8 bg-white`)}>
      ...
      <div className={tw(`flex flex-wrap items-center`)}>
        <div className={tw(`w-full lg:w-`)}>
          <p className={tw(`text-gray-500 leading-loose pb-2`)}>Стоимость ремонта однокомнатной квартиры в Геленджике с материалами, общей площадью 50 кв.м., класса комфорт (5500 руб./кв.м), составит примерно 550 000 руб.</p>
