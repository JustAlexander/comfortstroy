...
const socialProofs = [
  ...
  },
  {
    ...
    Комфорт Строй Про за высокий профессионализм и качественное выполнение ремонта
        ...
        <section>
          <div className={tw(`flex flex-wrap items-center`)}>
            ...
            <div className={tw(`w-full lg:w-1/2 px-2 pt-14`)}>
              <Image width="100%" height="100%" src="/images/otzyvy.avif" layout="responsive" alt="Ремонт однокомнатной квартиры в Краснодаре под ключ" />
            </div>
          </div>
        </section>
      </div>
